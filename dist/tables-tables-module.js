...
/*!***************************************************!*\
  !*** ./src/app/layout/tables/tables.component.ts ***!
  \***************************************************/
/*! exports provided: TablesComponent, UserShopping */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TablesComponent", function() { return TablesComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserShopping", function() { return UserShopping; });
/* harmony import */ var _event_event_service_event_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../event/event-service/event.service */ "./src/app/layout/event/event-service/event.service.ts");
...
var TablesComponent = /** @class */ (function () {
    function TablesComponent(eventService) {
    ...
    TablesComponent.prototype.ngOnInit = function () {
        ...
        this.eventService.getClients().subscribe(function (data) {
            console.log('retorno clientes', data);
            data.results.map(function (x) {
                _this.usuarios.push(x);
            });
        });
    };
    ...
    TablesComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_event_event_service_event_service__WEBPACK_IMPORTED_MODULE_0__["EventService"]])
    ], TablesComponent);
...
var UserShopping = /** @class */ (function () {
    function UserShopping(name, ddd, tel, sexo) {
        this.name = name;
        this.ddd = ddd;
        this.tel = tel;
        this.sexo = sexo;
