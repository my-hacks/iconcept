...
var map = {
	...
	"./charts/charts.module": [
		...
		"charts-charts-module~dashboard-dashboard-module~event-event-module~forms-forms-module~grid-grid-modu~f23517f1",
		"charts-charts-module~dashboard-dashboard-module~event-event-module~forms-forms-module~grid-grid-modu~a9723c22",
		"common",
		"charts-charts-module"
	],
	"./dashboard/dashboard.module": [
		...
		"charts-charts-module~dashboard-dashboard-module~event-event-module~forms-forms-module~grid-grid-modu~f23517f1",
		"dashboard-dashboard-module~event-event-module~forms-forms-module~grid-grid-module~layout-layout-modu~4edb8784",
		"charts-charts-module~dashboard-dashboard-module~event-event-module~forms-forms-module~grid-grid-modu~a9723c22",
		"common",
		"dashboard-dashboard-module"
	],
...
module.exports = __webpack_require__(/*! /Users/emerson/Documents/workspace/iguatemi/sb-admin-material/src/main.ts */"./src/main.ts");
